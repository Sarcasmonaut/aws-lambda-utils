...
describe("transformError tests", () => {
  test.each([
    [
      "a simple string",
      { error: "InternalServerError", message: "a simple string" },
    ],
    [
      { name: "expectedName", message: "expectedMessage" },
      { error: "expectedName", message: "expectedMessage" },
    ],
    [
    ...
    [
      { noMessage: "error message" },
      { error: "Object", message: { noMessage: "error message" } },
    ],
  ])(
